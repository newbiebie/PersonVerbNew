...
class RotationViewController: BaseController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
//        }
    ...
    lazy var titleLabel : UILabel = {
        let label : UILabel = UILabel(frame: CGRect(x: Int(SCREENW / 8), y: navHieght, width: Int(SCREENW * 3 / 4), height: 100))
