...
//系统动画
class ViewVerbViewController: BaseController {
    ...
    override func viewDidLoad() {
        ...
        self.printView = UIImageView.init(frame: CGRect.init(x: 0, y: CGFloat(navHieght), width: SCREENW, height: SCREENH - bottomHeight))
        self.behindView = UIImageView.init(frame: CGRect.init(x: 0, y: CGFloat(navHieght), width: SCREENW, height: SCREENH - bottomHeight))
